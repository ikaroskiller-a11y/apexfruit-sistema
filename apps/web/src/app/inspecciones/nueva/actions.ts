  ...
  try {
    inspeccion = await prisma.inspeccion.create({
      data: {
        ...
        presizerNumeroBin: parsed.data.presizerNumeroBin,
        presizerDistribucionCalibres: parsed.data.presizerDistribucionCalibres,
        presizerDistribucionColor: parsed.data.presizerDistribucionColor,
        presizerFalsoRechazoPct: parsed.data.presizerFalsoRechazoPct,
        presizerFalsoAceptadoPct: parsed.data.presizerFalsoAceptadoPct,
        presizerImpactosNuevosPct: parsed.data.presizerImpactosNuevosPct,
        presizerPerdidaPedicelo: parsed.data.presizerPerdidaPedicelo,
