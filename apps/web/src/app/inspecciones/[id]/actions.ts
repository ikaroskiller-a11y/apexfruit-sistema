...
function datosDesdeFormulario(formData: FormData) {
  return {
    ...
    presizerNumeroBin: formData.get("presizerNumeroBin"),
    presizerDistribucionCalibres: formData.get("presizerDistribucionCalibres"),
    presizerDistribucionColor: formData.get("presizerDistribucionColor"),
    presizerFalsoRechazoPct: formData.get("presizerFalsoRechazoPct"),
    presizerFalsoAceptadoPct: formData.get("presizerFalsoAceptadoPct"),
    presizerImpactosNuevosPct: formData.get("presizerImpactosNuevosPct"),
    presizerPerdidaPedicelo: formData.get("presizerPerdidaPedicelo"),
    ...
    await prisma.$transaction([
      prisma.inspeccion.update({
        ...
        data: {
          ...
          presizerNumeroBin: parsed.data.presizerNumeroBin ?? null,
          presizerDistribucionCalibres: parsed.data.presizerDistribucionCalibres ?? null,
          presizerDistribucionColor: parsed.data.presizerDistribucionColor ?? null,
          presizerFalsoRechazoPct: parsed.data.presizerFalsoRechazoPct ?? null,
          presizerFalsoAceptadoPct: parsed.data.presizerFalsoAceptadoPct ?? null,
          presizerImpactosNuevosPct: parsed.data.presizerImpactosNuevosPct ?? null,
          presizerPerdidaPedicelo: parsed.data.presizerPerdidaPedicelo ?? null,
